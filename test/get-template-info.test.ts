...
import { buildTemplateInfoData, formatTemplateInfo } from '../src/utils/get-template-info'
...
describe('formatTemplateInfo', () => {
  ...
  it('builds machine-readable template info data', () => {
    const result = buildTemplateInfoData({
      initInstructions: ['Run {pm} install'],
      options: {
        ollama: {
          default: true,
